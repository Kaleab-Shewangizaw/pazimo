...
const {
  ...
  declineShare,
  cancelShare,
} = require("../controllers/beverageShareController");

// Mirrors routes/ticketShareRoutes.js exactly, including reuse of its rate
// limiters — a generic per-IP budget on "search the user directory" /
// "create or respond to a transfer" that has nothing ticket-specific about
// it, so a second near-identical pair isn't worth the duplication.
