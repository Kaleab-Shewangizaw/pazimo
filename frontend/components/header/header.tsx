      ...
      >
        <div className="flex items-center justify-between gap-3 md:gap-6">
          ...
          <div className="flex md:hidden items-center justify-between w-full gap-3">
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              <Button
                variant="ghost"
                size="icon"
                className="p-2 rounded-full bg-white/40 dark:bg-white/[0.06] backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-[0_4px_16px_rgba(31,38,135,0.08)] dark:shadow-none text-gray-700 dark:text-white hover:text-[#115db1] dark:hover:text-blue-400 hover:bg-white/60 dark:hover:bg-white/10"
                onClick={() => {
                  setDialogOpen(true);
                  setMobileMenuOpen(false);
                }}
              ...
              <div className="rounded-full bg-white/40 dark:bg-white/[0.06] backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-[0_4px_16px_rgba(31,38,135,0.08)] dark:shadow-none [&>button]:rounded-full [&>button]:hover:bg-white/60 dark:[&>button]:hover:bg-white/10">
                <ThemeToggle />
              </div>

              <button
                className="p-2 rounded-full bg-white/40 dark:bg-white/[0.06] backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-[0_4px_16px_rgba(31,38,135,0.08)] dark:shadow-none text-gray-700 dark:text-white hover:text-[#115db1] dark:hover:text-blue-400 hover:bg-white/60 dark:hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-[#115db1] transition-colors"
          ...
          <div className="flex items-center gap-3">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              <DialogTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className="hidden md:flex p-2 rounded-full bg-white/40 dark:bg-white/[0.06] backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-[0_4px_16px_rgba(31,38,135,0.08)] dark:shadow-none text-gray-700 dark:text-white hover:text-[#115db1] dark:hover:text-blue-400 hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-200"
            ...
            {/* Theme toggle */}
            <div className="hidden md:flex items-center mr-2 rounded-full bg-white/40 dark:bg-white/[0.06] backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-[0_4px_16px_rgba(31,38,135,0.08)] dark:shadow-none [&>button]:rounded-full [&>button]:hover:bg-white/60 dark:[&>button]:hover:bg-white/10">
              <ThemeToggle />
            </div>
              ...
              <div className="hidden md:flex items-center gap-3">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="text-[#1a2d5a] dark:text-white font-medium bg-white/40 dark:bg-white/[0.06] backdrop-blur-xl border border-white/50 dark:border-white/10 shadow-[0_4px_16px_rgba(31,38,135,0.08)] dark:shadow-none hover:bg-white/60 dark:hover:bg-white/10 transition-all duration-200 rounded-full px-3 py-1 h-auto"
                    >
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="bg-white/70 dark:bg-black/60 backdrop-blur-2xl border border-white/50 dark:border-white/10 shadow-[0_16px_48px_rgba(31,38,135,0.15)] rounded-2xl p-4 space-y-3">
              <nav className="flex flex-col gap-2 text-sm font-medium text-muted-foreground dark:text-white">
                <button
              ...
              <div className="border-t border-border pt-4 mt-2 flex flex-col gap-3">
                {user ? (
                  <>
                    <button
                      className="w-full px-3 py-2 rounded-lg text-left text-foreground dark:text-white hover:bg-muted transition-colors font-medium"
