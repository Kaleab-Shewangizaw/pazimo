      ...
      return {
        ...
        contact:
          inv.type === "email"
            ...
            ? inv.guestPhone
            : inv.contact || inv.guestEmail || inv.guestPhone || "",
        ...
        estimatedCost:
          inv.estimatedCost ||
          (inv.type === "email"
            ? pricing.email * (inv.amount || 1)
            : inv.type === "sms" || inv.type === "phone"
            ? pricing.sms * (inv.amount || 1)
            : inv.type === "both"
            ? (pricing.email + pricing.sms) * (inv.amount || 1)
            : 0),
      };
    });
