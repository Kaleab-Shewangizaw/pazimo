                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="finance@pazimo.com">
                              Finance (finance@pazimo.com)
                            </SelectItem>
                            <SelectItem value="info@pazimo.com">
                              Information (info@pazimo.com)
                            </SelectItem>
                            <SelectItem value="organizers@pazimo.com">
                              Organizers (organizers@pazimo.com)
                            </SelectItem>
                            <SelectItem value="admin@pazimo.com">
                              Administration (admin@pazimo.com)
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
